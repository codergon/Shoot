...
const ChatMedia = ({ thisUser, addEmoji, messages, refresh }) => {
      ...
      <div className={sty.ctmed_col1}>
        <div className={sty.ctt_dets}>
          <div className={sty.ctt_ppic_cover}>
            <div
              className={sty.ctt_ppic_cont}
              style={
                {
                  // background: !thisUser?.photoURL && "transparent",
                  // border: !thisUser?.photoURL && "1px solid #888",
                }
              }
            >
              <div
